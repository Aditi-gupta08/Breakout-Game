...
const wall = new Wall(3, 7, 90, 100);
...
function drawPaddle() {
  ...
  ctx.fillStyle = "#feff89";       
  ctx.fillStyle = "#83ffe6";    // sea green
  ctx.fillStyle = "#fff6da";    // whitish
  ctx.fill();
    ...
    for(var r=0; r<wall.columnCount; r++) {
      ...
      if( cur_brick.status > 0) {
        ...
        if( cur_brick.status == 2)
        {
          ...
          ctx.fillStyle = "#f85959";  // reddish
          ctx.fillStyle = "fc6b3f";   // redish
          ctx.fillStyle = "#bd1628";   // redish
        ...
        else if ( cur_brick.status == 1)
        {
          ...
          ctx.fillStyle = "#ff9f68";       // orange
          ctx.fillStyle = "#ffc768";       // orange
          ctx.fillStyle = "#f63c41";       // orange
          ctx.fill();
